...
def storeValue(key, value):
    ...
    global node
    # Correct the print statement syntax
    print("\nStoring value; Key: %s, Value: %s" % (key, value))

    # Store the value in the DHT. This method returns a Twisted Deferred result,
    # which we then add callbacks to.
    ...
    # In a real-world scenario, you would usually want to specify a more
    # detailed error handler depending on the kind of errors you expect.
